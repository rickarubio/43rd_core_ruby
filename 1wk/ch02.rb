...
=end
require 'rubygems'
gem "ruby-units", "~> 1.4.3"

def welcome_message
  puts "Welcome to temperature unit converter v1.0"
  puts "Currently supports conversions between these units:"
  puts "(C)elsius, (F)ahrenheit, (K)elvin, and (R)ankine"
  puts "Examples of valid conversion requests:"
  puts "50 C to F"
  puts "-14F to C"
  puts "299.817      K to R"
  puts "etc..."
...
welcome_message()
print "Enter your temperature conversion request:"
conversion_request = gets.chomp
